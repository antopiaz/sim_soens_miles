...
from .soen_simulate import run_soen_sim
...
class dendrite():
    ...
    def __init__(self, **params):
        ...
        Ic = self.Ic * 1e-6
        Ldi = 6.62606957e-34/(2*1.60217657e-19)*beta_di/(2*np.pi*Ic)
        rdi = Ldi/tau_di
...
class neuron():
    ...
    def __init__(self, **params):
        ...
        Ic = self.Ic * 1e-6
        Lni = 6.62606957e-34/(2*1.60217657e-19)*beta_ni/(2*np.pi*Ic)
        rni = Lni/tau_ni
        ...
        Lnr = 6.62606957e-34/(2*1.60217657e-19)*beta_nr/(2*np.pi*Ic)
        r_ref = Lnr/tau_ref
